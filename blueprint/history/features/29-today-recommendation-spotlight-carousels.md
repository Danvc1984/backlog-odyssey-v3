...
- [x] 1. Make role assignment and labels match the five-role contract.
...
- [x] 2. Replace separate dismiss and rotate mutations with one authenticated dismissal-and-replacement contract.
...
- [x] 3. Build the shared spotlight slide and apply the unified action to every recommendation surface.
...
- [x] 4. Compose Today’s Play Next and Buy spotlight carousels.
...
- [x] 5. Verify the complete feature.
...
<!-- blueprint:completion {"schemaVersion":1,"specBytes":14926,"specSha256":"e4d1621ecd50789675d40d48e855b2b4369de70259fc8d624071a38db7f1f653","branch":"refs/heads/feature/today-recommendation-spotlight-carousels","head":"cf40382ef79efd47bf3ecdbb565ef76ff207cf91","baseRef":"refs/heads/main","baseCommit":"cf40382ef79efd47bf3ecdbb565ef76ff207cf91","sourceTree":"7d92da75e49000eda7e9beb0c2d0dc4a2e70edf7","absentOptional":[]} -->

## Verification

- `pnpm typecheck` passed.
- `pnpm test` passed: 129 files and 1245 tests.
- `pnpm build` passed.
- Signed-in live verification was completed by the owner on Today and recommendation detail surfaces.

## Manual try

1. Sign in and open `/today`; update recommendations if needed.
2. Use the Play Next and Purchase carousel controls, then wait ten seconds to confirm automatic advance. Hover, focus, or use controls to pause it; enable reduced motion to keep it manual.
3. Use **Show me another option** and refresh to confirm the replacement or removal persists.
4. Open a recommended wishlist entry and select the provider name when a valid offer exists.
