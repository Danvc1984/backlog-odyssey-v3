...
- [ ] **Step 1 - Token foundation in `globals.css`** - Re-theme the shadcn
      ...
      pass.
- [ ] **Step 2 - Mode switching and the theme control** - Mount
...
- [ ] **Step 3 - Reduced motion and reduced data preferences** - Add a
      ...
      pass.
- [ ] **Step 4 - App shell restyle** - Restyle the desktop sidebar (brand
...
- [ ] **Step 5 - Buttons, cards, and shared surfaces** - Re-theme `Button`
