  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-12">
      <section className="w-full max-w-xl rounded-xl border border-border bg-card p-6 shadow-card sm:p-8">
        <p className="technical-label text-muted-foreground">Welcome aboard</p>
        <h1 className="mt-2 text-3xl font-bold tracking-[-0.04em]">Set your course</h1>
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Tell Backlog Odyssey which devices will carry your voyage through compatibility and recommendations. You can change it later.
        </p>
