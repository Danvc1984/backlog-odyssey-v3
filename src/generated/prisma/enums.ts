...
export const MatchMethod = {
  ...
  MANUAL_IGDB_SEARCH: 'MANUAL_IGDB_SEARCH',
...
export const UnresolvedDlcSource = {
  OWNED_SYNC: 'OWNED_SYNC',
  WISHLIST_IMPORT: 'WISHLIST_IMPORT'
} as const

export type UnresolvedDlcSource = (typeof UnresolvedDlcSource)[keyof typeof UnresolvedDlcSource]


export const WishlistImportReviewStatus = {
  OPEN: 'OPEN',
  LINKED: 'LINKED',
  IGNORED: 'IGNORED'
} as const

export type WishlistImportReviewStatus = (typeof WishlistImportReviewStatus)[keyof typeof WishlistImportReviewStatus]
...
export const PriceIdentityProvenance = {
  ...
  IGDB_SUGGESTION: 'IGDB_SUGGESTION'
} as const
